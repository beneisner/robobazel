...
load("//third_party/gflags:load_gflags.bzl", _load_gflags = "load_gflags")
load("//third_party/glog:load_glog.bzl", _load_glog = "load_glog")
...
load_gflags = _load_gflags
load_glog = _load_glog
